...
export default function Benefits() {
  ...
  return (
    <div
      id="benefits"
      className="max-w-6xl scroll-my-32 mx-auto flex justify-between"
    >
      <div className="flex flex-col gap-8">
        <h1 className="text-3xl font-bold">Tons of benefits</h1>
        ...
        <button className="bg-hdark font-medium px-12 py-3 rounded-xl text-background mt-5 w-fit">
          Sign Up
        </button>
      </div>
